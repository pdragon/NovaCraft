...
/// Novacraft - Main JSON
/// </summary>
public class NovacraftMainJson
{
    /// <summary>
    /// Processes NovacraftMainJson Libraries
    /// </summary>
    /// <param name="json">Original instance</param>
    /// <returns>Processed instance</returns>
    [SuppressMessage("ReSharper", "PossibleNullReferenceException")]
    private static NovacraftMainJson ProcessLibraries(NovacraftMainJson json)
    {
    ...
    public static NovacraftMainJson MojangToNovacraft(MojangMainJson mojang)
    {
        var json = new NovacraftMainJson {
    ...
    /// <param name="mojang">Mojang JSON</param>
    /// <returns>Novacraft JSON</returns>
    public static NovacraftMainJson MojangToNovacraftPartial(MojangMainJson mojang)
    {
        var json = new NovacraftMainJson {
            MainClass = mojang.MainClass,
            Type = mojang.Type,
    ...
    /// <param name="mojang">Legacy Mojang JSON</param>
    /// <returns>Novacraft JSON</returns>
    public static NovacraftMainJson MojangToNovacraft(MojangLegacyMainJson mojang)
    {
        var json = new NovacraftMainJson {
            MainClass = mojang.MainClass,
            Type = mojang.Type,
            Author = "Mojang Studios",
            Information = "Mojang Legacy JSON made to work with Novacraft",
            JavaMajor = mojang.JavaVersion.Major,
            Arguments = new JsonArguments {
    ...
    /// <param name="mojang">Legacy Mojang JSON</param>
    /// <returns>Novacraft JSON</returns>
    public static NovacraftMainJson MojangToNovacraftPartial(MojangLegacyMainJson mojang)
    {
        var json = new NovacraftMainJson {
            MainClass = mojang.MainClass,
            Author = "Mojang Studios",
