...
public static class FilesManager
{
    ...
    {        
        public static readonly string Root =
            Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), ".Novacraft");
        //public static readonly string Root =
        //    Path.Combine(Path.Combine("r:\\public\\share\\"), ".Novacraft");
    ...
    //public static MojangAssetsJson LoadMojangAssets(string version, bool online, NovacraftMainJson mainJSON = null)
    public static MojangAssetsJson LoadMojangAssets(LauncherConfig.ModPack modpack, bool online, NovacraftMainJson mainJSON = null)
    {
    ...
    {
        NovacraftMainJson main = (MojangFetcher.GetMain(modpack.Version.Id));
        NovacraftAssetsJson.JsonAsset jsonAsset = new NovacraftAssetsJson.JsonAsset()
        {
            Name = main.Assets.Id,
    ...
    /// Downloads an asset
    /// </summary>
    /// <param name="asset">Novacraft Asset JSON</param>
    /// <param name="online">Is in online mode</param>
    public static void DownloadAsset(NovacraftAssetsJson.JsonAsset asset, LauncherConfig.ModPack modpack, bool online)
    {
    ...
    /// Get library path
    /// </summary>
    /// <param name="library">Novacraft Library JSON</param>
    /// <returns>Path</returns>
    public static string GetLibraryPath(LauncherConfig.ModPack modpack, NovacraftMainJson.JsonLibrary library)
    ...
    //public static string GetLibraryPath(NovacraftMainJson.JsonLibrary library)
    ...
    //public static void DownloadLibrary(NovacraftMainJson.JsonLibrary library, string version, bool online)
    public static void DownloadLibrary(NovacraftMainJson.JsonLibrary library, LauncherConfig.ModPack modpack, bool online)
    {
    ...
    /// <param name="online">Is in online mode</param>
    public static void DownloadClient(LauncherConfig.ModPack modpack, NovacraftMainJson main, bool online)
    {
    ...
    */
    ...
    public static List<NovacraftMainJson.JsonLibrary> GetForgeLibrariesPaths(LauncherConfig.ModPack modpack, string version)
    {
        var result = new List<NovacraftMainJson.JsonLibrary>();
        ...
        foreach (string filename in installFiles)
        {
            ...
            if (ForgeInstallerJson.IsOwnJson(d))
            {
                ...
                foreach (var library in actualJson.Libraries)
                {
                    ...
                    result.Add(new NovacraftMainJson.JsonLibrary
                    {
    ...
    public static JavaDownloadError JavaDownload(NovacraftMainJson main, ProgressTask task, LauncherConfig.ModPack modpack, bool online)
    {
