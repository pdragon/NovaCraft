...
//using static Novacraft.Library.ForgeInstallerJson;
...
namespace Novacraft.Library
{
    public class ForgeLegacyInstallerJson
    {
        ...
        public static NovacraftMainJson ForgeToNovacraftPartial(ForgeLegacyInstallerJson mojang)
        {
            var json = new NovacraftMainJson
            {
                MainClass = mojang.VersionInfo.MainClass,
                Author = "LexManos",
                Information = "Forge Legacy JSON made to work with Novacraft",
