...
@ "c:\Program Files\dotnet\dotnet" publish --no-build -r %1 --configuration Release --output ./publish/%1
@rem "c:\Program Files\dotnet\dotnet" publish --no-build -r %1 --configuration Release -p:PublishSingleFile=true --output ./publish/%1
@call clean.cmd %1
